<?php if (!empty($_GET['edit_thuc_don']) && current_user_can( 'administrator' )): ?>
	<div class="wrap">
		<form action="" method="POST" class="form-horizontal" role="form">
			...
			$result = $wpdb->get_row( 'SELECT * FROM '.$wpdb->prefix.'thuc_don WHERE id = "'.$_GET['edit_thuc_don'].'"' ); 
			...
			<?php if (!empty($result)): ?>
				...
				<tr class="vb-header">
					<td><b>Ngày:</b></td>
					<td>
						<input type="text" id="ndt" name="td_ngay" style="width: 100%;" value="<?php echo $result->td_ngay ?>">
						<input type="date" id="dt" onchange="mydate1();" style="width: 100%">
						<input type="text" id="day" name="td_thu" value="<?php echo $result->td_thu ?>" style="width: 100%;">
					</td>
				</tr>
				...
				<td class="vb-nguyenlieu-bs">
					<input type="text" name="td_ma8" style="display: none" value="0">
						<select class="vb-nl-sl8">
							<?php 
							$vbma18=$result->td_ma8;
							if($vbma18 != "0"){
								$pieces = explode(" ", $vbma18);
								$pieceslng=count($pieces);	
								$piecesten="";
								$i=0;
								for($i=0;$i<$pieceslng-1;$i++)	{
				...
				<td class="vb-nguyenlieu-bs">
					<input type="text" name="td_ma10" style="display: none" value="0">
						<select class="vb-nl-sl10">
							<?php 
							$vbma10=$result->td_ma10;
							if($vbma10 != "0"){
								$pieces = explode(" ", $vbma10);
								$pieceslng=count($pieces);	
								$piecesten="";
								$i=0;
								for($i=0;$i<$pieceslng-1;$i++)	{
				...
				<tr>
					<td><b>Năng lượng (E):</b><input type="text" name="td_e" value="<?php echo $result->td_e  ?>"></td>
				</tr>
				<tr>
					<td><b>Protein (P):</b><input type="text" name="td_p" value="<?php echo $result->td_p  ?>"></td>
					<td><b>Chất Béo (L):</b><input type="text" name="td_l" value="<?php echo $result->td_l  ?>"></td>
					<td><b>Cacbohydrate (G):</b><input type="text" name="td_g" value="<?php echo $result->td_g  ?>"></td>
				</tr>
				<tr>
					<td><b>Sắt (Fe):</b><input type="text" name="td_fe" value="<?php echo $result->td_fe  ?>"></td>
					<td><b>Kém (Zn):</b><input type="text" name="td_zn" value="<?php echo $result->td_zn  ?>"></td>
					<td><b>Chất Xơ:</b><input type="text" name="td_xo" value="<?php echo $result->td_xo ?>"></td>
				</tr>
				<tr>
					<td><b>Canxi (Ca):</b><input type="text" name="td_ca" value="<?php echo  $result->td_ca ?>"></td>
					<td><b>Natri (Na):</b><input type="text" name="td_na" value="<?php echo $result->td_na  ?>"></td>
					<td><b>Cholestrol (Cho):</b><input type="text" name="td_cho" value="<?php echo  $result->td_cho ?>"></td>
				</tr>
			</table>
				<br>
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
						...
						number1 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e1=number1;
                        number2 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p1=number2;
                        number3 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l1=number3;
                        number4 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g1=number4;
                        number5 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe1=number5;
                        number6 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo1=number6;
                        number7 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca1=number7;
                        number8 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na1=number8;
                        number9 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn1=number9;                       
                        number10 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho1=number10;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
            	...
            	Math.round((vbnltotal-vbnlsang-vbnltrua)*100)/100;
                td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            	td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            	td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
            	td_g=td_g1+td_g2+td_g3+td_g4+td_g5+td_g6+td_g7+td_g8+td_g9+td_g10;
		...
		jQuery('select.vb-nl-sl2').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number11 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e2=number11;
                        number21 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p2=number21;
                        number31 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l2=number31;
                        number41 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g2=number41;
                        number51 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe2=number51;
                        number61 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo2=number61;
                        number71 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca2=number71;
                        number81 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na2=number81;
                        number91 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn2=number91;                       
                        number101 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho2=number101;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl3').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number12 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e3=number12;
                        number22 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p3=number22;
                        number32 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l3=number32;
                        number42 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g3=number42;
                        number52 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe3=number52;
                        number62 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo3=number62;
                        number72 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca3=number72;
                        number82 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na3=number82;
                        number92 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn3=number92;                       
                        number102 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho3=number102;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl4').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number13 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e4=number13;
                        number23 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p4=number23;
                        number33 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l4=number33;
                        number43 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g4=number43;
                        number53 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe4=number53;
                        number63 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo4=number63;
                        number73 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca4=number73;
                        number83 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na4=number83;
                        number93 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn4=number93;                       
                        number103 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho4=number103;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl5').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number14 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e5=number14;
                        number24 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p5=number24;
                        number34 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l5=number34;
                        number44 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g5=number44;
                        number54 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe5=number54;
                        number64 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo5=number64;
                        number74 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca5=number74;
                        number84 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na5=number84;
                        number94 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn5=number94;                       
                        number104 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho5=number104;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl6').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number15 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e6=number15;
                        number25 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p6=number25;
                        number35 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l6=number35;
                        number45 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g6=number45;
                        number55 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe6=number55;
                        number65 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo6=number65;
                        number75 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca6=number75;
                        number85 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na6=number85;
                        number95 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn6=number95;                       
                        number105 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho6=number105;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl7').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number16 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e7=number16;
                        number26 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p7=number26;
                        number36 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l7=number36;
                        number46 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g7=number46;
                        number56 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe7=number56;
                        number66 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo7=number66;
                        number76 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca7=number76;
                        number86 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na7=number86;
                        number96 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn7=number96;                       
                        number106 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho7=number106;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl8').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number17 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e8=number17;
                        number27 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p8=number27;
                        number37 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l8=number37;
                        number47 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g8=number47;
                        number57 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe8=number57;
                        number67 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo8=number67;
                        number77 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca8=number77;
                        number87 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na8=number87;
                        number97 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn8=number97;                       
                        number107 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho8=number107;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl9').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number18 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e9=number18;
                        number28 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p9=number28;
                        number38 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l9=number38;
                        number48 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g9=number48;
                        number58 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe9=number58;
                        number68 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo9=number68;
                        number78 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca9=number78;
                        number88 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na9=number88;
                        number98 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn9=number98;                       
                        number108 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho9=number108;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
...
jQuery('select.vb-nl-sl10').change(function() {        
            ...
            jQuery.ajax({
                ...
                success:function(response){ 
                    if (response != 0) {
                        response = JSON.parse(response);
						number19 = Number(response[0].bs_e.replace(/[^0-9.]+/ig, ""));
                        td_e10=number19;
                        number29 = Number(response[0].bs_p.replace(/[^0-9.]+/ig, ""));
                        td_p10=number29;
                        number39 = Number(response[0].bs_l.replace(/[^0-9.]+/ig, ""));
                        td_l10=number39;
                        number49 = Number(response[0].bs_g.replace(/[^0-9.]+/ig, ""));
                        td_g10=number49;
                        number59 = Number(response[0].bs_fe.replace(/[^0-9.]+/ig, ""));
                        td_fe10=number59;
                        number69 = Number(response[0].bs_xo.replace(/[^0-9.]+/ig, ""));
                        td_xo10=number69;
                        number79 = Number(response[0].bs_ca.replace(/[^0-9.]+/ig, ""));
                        td_ca10=number79;
                        number89 = Number(response[0].bs_na.replace(/[^0-9.]+/ig, ""));
                        td_na10=number89;
                        number99 = Number(response[0].bs_zn.replace(/[^0-9.]+/ig, ""));
                        td_zn10=number99;                       
                        number109 = Number(response[0].bs_cho.replace(/[^0-9.]+/ig, ""));
                        td_cho10=number109;
                        td_e=td_e1+td_e2+td_e3+td_e4+td_e5+td_e6+td_e7+td_e8+td_e9+td_e10;
            			td_p=td_p1+td_p2+td_p3+td_p4+td_p5+td_p6+td_p7+td_p8+td_p9+td_p10;
            			td_l=td_l1+td_l2+td_l3+td_l4+td_l5+td_l6+td_l7+td_l8+td_l9+td_l10;
