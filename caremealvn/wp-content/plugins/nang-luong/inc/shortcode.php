...
function create_shortcode_nang_luong() {
...
?>
    ...
    // _____________________Load Nhu cầu năng lượng hàng ngày_____________________________
        ...
        jQuery('select[name="nc_gt"]').change(function() {
         ...
         // _____________________End Nhu cầu năng lượng hàng ngày_____________________________
        ...
        jQuery('#dt').change(function() {
            ...
            if(dt<10){
                ...
                jQuery("#ndt").val("0"+dt+"/"+mn+"/"+yy);

                 if(mn<10){

                jQuery("#ndt").val("0"+dt+"/0"+mn+"/"+yy);

                }

            }else if(mn<10){

                jQuery("#ndt").val(dt+"/0"+mn+"/"+yy);

            }else {

                jQuery("#ndt").val(dt+"/"+mn+"/"+yy);

            }     

            if(jQuery('input[name="td_ngay"]').val() !="0"){
            ...
            jQuery.ajax({
                ...
                data:{'ngay':jQuery('input[name="td_ngay"]').val()},
                ...
                success:function(response){
                    ...
                    if (response != 0) {
                        ...
                        for(j=0;j < response.length;j++){
                            ...
                            jQuery('.vb-mon-trua').append('<h2>Bữa ăn trưa (' +response[j].td_thu+' ngày: '+response[j].td_ngay+ ') </h2>');
                            ...
                            jQuery('.vb-mon-trua').append('<p><span>'+response[j].td_ma1+'</span><span>'+response[j].td_ma2+'</span><span>'+response[j].td_ma3+'</span><span>'+response[j].td_ma4+'</span><span>'+response[j].td_ma5+'</span><span>'+response[j].td_ma6+'</span><span>'+response[j].td_ma7+'</span><span>'+response[j].td_ma8+'</span><span>'+response[j].td_ma9+'</span><span>'+response[j].td_ma10+'</span></p>');

                            jQuery('.vb-mon-trua').append('<p class="vb-kqtrua"><span><b>Năng lượng: </b>'+response[j].td_e+'kcal</span><span><b>Protein: </b>'+response[j].td_p+'g</span><span><b>Glucid: </b>'+response[j].td_g+'mg</span><span><b>Lipid: </b>'+response[j].td_l+'mg</span><p>')
                        ...
                        alert("Chưa có thực đơn cho ngày này");
        ...
        function ketqua(){
            ...
            var vbnltrua = Number(jQuery(jQuery('.vb-mon-trua .vb-kqtrua span')[0]).text().replace(/[^0-9.]+/ig, ""));

            var vbptrua = Number(jQuery(jQuery('.vb-mon-trua .vb-kqtrua span')[1]).text().replace(/[^0-9.]+/ig, ""));

            var vbcltrua = Number(jQuery(jQuery('.vb-mon-trua .vb-kqtrua span')[2]).text().replace(/[^0-9.]+/ig, ""));

            var vbsltrua = Number(jQuery(jQuery('.vb-mon-trua .vb-kqtrua span')[3]).text().replace(/[^0-9.]+/ig, ""));
...
add_shortcode( 'nang_luong', 'create_shortcode_nang_luong' );