...
class WPLE_Admin
{
    ...
    public function wple_cpanel_pricing_table( $cpanel = '' )
    {
      ...
      <h2 class="pricing-intro-head"><?php 
        esc_html_e( 'SAVE $60+ EVERY YEAR IN SSL CERTIFICATE FEE', 'wp-letsencrypt-ssl' );
        ?></h2>

      <h4 class="pricing-intro-subhead">One time purchase! Hassle free Lifetime SSL with our PRO plugin - Trusted Globally by <b>40,000+</b> WordPress Sites (Looking for <a href="<?php 
    ...
    public function wple_intro_pricing_handler()
    {
        ...
        if ( isset( $_GET['gofree'] ) ) {
            ...
            if ( isset( $_GET['gopro'] ) ) {
                ...
                if ( $_GET['gopro'] == 2 ) {
                    //unlimited
                    wp_redirect( admin_url( '/admin.php?page=wp_encryption-pricing&checkout=true&plan_id=8210&plan_name=pro&billing_cycle=lifetime&pricing_id=10873&currency=usd' ), 302 );
                } else {
